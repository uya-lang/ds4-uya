...
- 后续让 Uya SIMD 后端生成 x86_64 快路径；必要时为热点 kernel 单独组织 4/8/16 lane 版本。
...
当前已经实现到 sampler/CLI generation entrypoint 阶段：
...
- binary/GGUF/tokenizer/tensor/kernel/model/sampler 测试。
